      ...
      >
        <div className="mx-auto flex h-16 max-w-[1200px] items-center justify-between px-6">
            ...
            {NAV_LINKS.map((link) => {
              ...
              return (
                <a
                  ...
                  href={link.href}
                  className={cn(
                    "relative rounded-lg px-3.5 py-2 font-sans text-sm transition-colors duration-200",
                    isActive
                      ? "text-white"
          ...
          <motion.button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/10 bg-white/4 text-white/70 transition-colors hover:text-white md:hidden"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed top-16 right-0 left-0 z-99 border-b border-white/6 bg-forge-bg/95 px-6 py-4 backdrop-blur-2xl md:hidden"
          >
            {NAV_LINKS.map((link, i) => (
              <motion.a
                ...
                className="block rounded-lg px-3 py-3 font-sans text-sm text-white/60 transition-colors hover:bg-white/4 hover:text-white"
              >
                {link.label}
              </motion.a>
            ))}
