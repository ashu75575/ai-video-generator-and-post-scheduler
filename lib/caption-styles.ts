...
export const CAPTION_STYLES: CaptionStyle[] = [
  ...
  },
  {
    ...
    textShadow: `
      0 0 10px rgba(161, 136, 125, 0.8),
      0 0 20px rgba(161, 136, 125, 0.4),
      0 0 30px rgba(161, 136, 125, 0.2)
    `,
    backgroundColor: "rgba(26, 26, 26, 0.95)",
    borderRadius: "20px",
    padding: "20px 40px",
    border: "1px solid rgba(152, 61, 22, 0.3)",
    gap: "20px",
  ...
  },
  {
    ...
    borderRadius: "16px",
    padding: "22px 42px",
    border: "1px solid rgba(152, 61, 22, 0.2)",
    gap: "22px",
